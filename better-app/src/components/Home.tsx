...
class Home extends React.Component<any,any>{
    ...
    render(){
        const {tasks,loaderHome,add_task,task_select,addRequest_click, add_request, task_selected}=this.props
        ...
        return<div>
                    ...
                    <div className="home-sec1">
                        ...
                        <TaskList loaderHome={loaderHome} tasks={tasks} task_selected={task_selected} randomprops={this.props}/>}
                    </div>
                </div>
    }
}
